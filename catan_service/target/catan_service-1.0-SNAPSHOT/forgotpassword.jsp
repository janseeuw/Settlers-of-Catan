<%-- 
    ...
    Created on : 5-apr-2013, 18:41:35
    Author     : Joachim
--%>
...
<html>
  <head>
    <title><fmt:message key="forgotPassTitle" bundle="${msg}"/></title>
  ...
  <body>
    <div class="navbar navbar-static-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <form id="languageForm"  class="navbar-form pull-right" action="forgotpasswords.jsp">
    ...
    <div class="container">
      <div class="page-header">
        <h1><fmt:message key="resetPass" bundle="${msg}"/>/h1>
      </div>
      <form id="forgotPasswordForm" class="form-horizontal">
        ...
        <div class="form-actions">
          <button type="submit" class=" btn btn-primary"><fmt:message key="reset" bundle="${msg}"/></button>
        </div>
      </form>
      <div class="success" style="display: none;"><p><fmt:message key="emailSucces" bundle="${msg}"/></p><p><fmt:message key="returnLobby" bundle="${msg}"/></p></div>
      <div class="error" style="display: none;"><fmt:message key="emailError" bundle="${msg}"/></div>
    </div>
